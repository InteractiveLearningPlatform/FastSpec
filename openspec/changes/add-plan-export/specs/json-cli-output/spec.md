...
The FastSpec CLI MUST support machine-readable JSON output for `summary`, `validate`, `graph`, and `plan` commands so automation can consume all derived runtime views directly.
