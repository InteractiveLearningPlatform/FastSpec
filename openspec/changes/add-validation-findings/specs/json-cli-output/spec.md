...
The FastSpec CLI MUST support machine-readable JSON output for the `summary` and `validate` commands so automation can consume overview and validation data without terminal scraping.
